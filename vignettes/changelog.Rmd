...
-    created function with `use_r("getBathym")`
    -   inserted roxygen skeleton to build help file (insert cursor in
        script, then code -\> insert roxygen skeleton
    -   Created `.rd` documentation with `devtools::document()`
